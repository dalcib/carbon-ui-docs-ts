...
class Theme extends Component {
    render() {
        ...
        <Caption style={styles.smallBreak}>
          Check out the{' '}
          <Link to="https://github.com/tuckerconnelly/carbon-ui/blob/master/src/theme/themes/light.js" style={styles.captionLink}>
...
export default createLeafOrchestrator('theme')(connectTheme(Theme));
const tStyles = (theme) => ({
    break: {
        marginBottom: 8 * gu,
    },
    ...
    captionLink: Object.assign({}, Type.caption, { color: Colors.lightBlue400 }),
    headline: {
        marginBottom: 4 * gu,
        color: theme.colors.primary,
    },
