...
import { Display4, Display3, Display2, Display1, Headline, Title, Subheading, Body2, Body1, Caption, Colors, gu, connectTheme } from 'carbon-ui';
...
export default createLeafOrchestrator('typography')(connect(null, { pushState })(connectTheme(Typography)));
const tStyles = (theme) => ({
    break: {
        marginBottom: 8 * gu,
    },
