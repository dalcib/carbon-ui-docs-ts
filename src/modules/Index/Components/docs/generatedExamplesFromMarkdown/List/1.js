...
export default class Example extends Component {
    ...
    render() {
        return (<View style={Object.assign({}, Elevation.dp2)}>
         <List>
           <ListItem primaryText="Nested item" expanded={this.state.expandedItems.indexOf('nestedItem') !== -1} onPress={() => this._toggleExpandedItem('nestedItem')}>
