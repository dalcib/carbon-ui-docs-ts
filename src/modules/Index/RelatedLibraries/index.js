...
import IC from '../../common/InlineCode';
...
class RelatedLibraries extends Component {
    render() {
        ...
        <View style={styles.smallBreak}>
          <Link to="https://github.com/tuckerconnelly/uranium" style={styles.dependencyLink}>
            uranium
          </Link>
          <Body1>
        ...
        <View style={styles.smallBreak}>
          <Link to="https://github.com/tuckerconnelly/react-stack-nav" style={styles.dependencyLink}>
            react-stack-nav
          </Link>
          <Body1>
        ...
        <View style={styles.smallBreak}>
          <Link to="https://github.com/tuckerconnelly/react-native-match-media" style={styles.dependencyLink}>
        ...
        <View style={styles.smallBreak}>
          <Link to="https://github.com/tuckerconnelly/react-native-ps" style={styles.dependencyLink}>
            react-native-ps
          </Link>
          <Body1>
        ...
        <View style={styles.smallBreak}>
          <Link to="https://github.com/tuckerconnelly/react-native-web" style={styles.dependencyLink}>
...
export default createLeafOrchestrator('related-libraries')(connectTheme(RelatedLibraries));
const tStyles = (theme) => ({
    break: {
        marginBottom: 8 * gu,
    },
