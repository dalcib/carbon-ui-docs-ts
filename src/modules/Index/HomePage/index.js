...
import { Animated, Platform, Image, TouchableOpacity, Linking, Text, View } from 'react-native';
import { pushState } from 'react-stack-nav';
import Uranium, { animate } from 'uranium';
import ps from 'react-native-ps';
import { Display2, Subheading, Body2, Body1, Paper, RaisedButton, Animations, Breakpoints, Colors, gu, connectTheme } from 'carbon-ui';
...
export class HomePage extends Component {
    constructor() {
        ...
        this._goToInstallation = () => this.props.pushState(0, 'Installation', '/getting-started/installation');
        this._navigateExternal = (url) => Linking.openURL(url);
        this._electronSpinTimeout = null;
        this._electronsAV = new Animated.Value(0);
    }
    componentDidMount() {
    ...
    render() {
        ...
        <View style={styles.heading}>
          <View style={styles.logo}>
            <Image source={require('../../../assets/images/app-logo-copy.png')} style={styles.logoCopy}/>
            <Animated.Image source={require('../../../assets/images/app-logo-electrons.png')} renderToHardwareTextureAndroid style={[
        ...
        <Content style={styles.copy}>
          ...
          <RaisedButton style={styles.getStarted} onPress={this._goToInstallation}>
            Get started
          </RaisedButton>
          ...
          {Platform.OS === 'web' &&
            <View style={styles.viewNatively}>
              ...
              <View style={styles.badges}>
                <TouchableOpacity style={styles.badgeButton} onPress={() => this._navigateExternal(APP_STORE_URL)}>
                  <Image style={styles.badgeAppStore} source={require('../../../assets/images/badge-app-store.svg')}/>
                </TouchableOpacity>
                <TouchableOpacity style={styles.badgeButton} onPress={() => this._navigateExternal(GOOGLE_PLAY_URL)}>
                  <Image style={styles.badgeGooglePlay} source={require('../../../assets/images/badge-google-play.png')}/>
                </TouchableOpacity>
              </View>
            </View>}
        </Content>
...
export default createLeafOrchestrator('')(connect(null, mapDispatchToProps)(connectTheme(Uranium(HomePage))));
