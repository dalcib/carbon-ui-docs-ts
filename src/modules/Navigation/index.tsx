...
interface NavigationProps {url: string, pushState: (...args: any[]) => any, menuOpen: boolean, closeMenu: (...args: any[]) => any, theme: theme}
interface NavigationState {expandedItems?: any[], finishedOpening?: boolean, contentVisible?: boolean}
class Navigation extends Component<NavigationProps, NavigationState> {
  static propTypes: any
  state = { expandedItems: [], finishedOpening: false, contentVisible: undefined }
  
  _navigate = (to: any, title = '') => {
    this.props.closeMenu()
    this.props.pushState(0, title, to)
  }
  
  _toggleExpandedItem = (name: string) => {
  ...
  _openExternalLink = (url: string) => Linking.openURL(url)
...
const mapStateToProps = ({ navigation, app }: any) => ({
