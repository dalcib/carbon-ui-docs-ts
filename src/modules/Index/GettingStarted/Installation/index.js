...
class Installation extends Component {
    render() {
        ...
        <View style={styles.smallBreak}>
          <Link to="https://github.com/facebook/react-native" style={styles.dependencyLink}>
            react-native
          </Link>
          <Body1>If you want to run carbon-ui natively.</Body1>
        </View>
        <View style={styles.smallBreak}>
          <Link to="https://github.com/necolas/react-native-web" style={styles.dependencyLink}>
            react-native-web
          </Link>
...
export default createLeafOrchestrator('installation')(connectTheme(Installation));
const tStyles = (theme) => ({
    break: {
        marginBottom: 8 * gu,
    },
